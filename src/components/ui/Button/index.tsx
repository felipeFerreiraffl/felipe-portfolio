...
export default function Button({
  ...
  const baseClasses = `min-w-30 cursor-pointer font-body font-bold text-base leading-body uppercase py-3 px-5 bg-bg text-text border text-center border-main rounded-sm shadow-normal transition-all duration-300 ease-in-out`;
